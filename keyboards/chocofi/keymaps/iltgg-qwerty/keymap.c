...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMPAD] = LAYOUT_split_3x5_3(
        ...
        OSM(MOD_LALT), OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LCTL), KC_NO,                                     KC_PAST, KC_P4, KC_P5, KC_P6, KC_PPLS,
        KC_DOWN,       KC_UP,         KC_NO,         KC_NO,         KC_NO,                                     KC_SPC,  KC_P1, KC_P2, KC_P3, KC_PSLS,
                                                     KC_NO,         KC_NO,         TD(TD_NUM_MACRO),    KC_BSPC, KC_P0,   KC_PDOT
    ),
    [_MACRO] = LAYOUT_split_3x5_3( // TODO: fill in macros
        ...
        KC_F,    KC_B,    KC_K,    KC_L,    KC_J,                                       KC_Z,     KC_W,    KC_COMM, KC_DOT,  KC_SLSH,
                          KC_NO,   KC_R,    TD(TD_NUM_MACRO),                    KC_NO, KC_SPC,   KC_NO
    ),
...
void dance_num_macro_each(tap_dance_state_t *state, void *user_data) {
    switch (state->count) {
        case 1:
            layer_on(_NUMBER);
            break;
...
void dance_num_macro_reset(tap_dance_state_t *state, void *user_data) {
    layer_off(_NUMBER);
    layer_off(_MACRO);
}
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_NUM_MACRO] = ACTION_TAP_DANCE_FN_ADVANCED(dance_num_macro_each, NULL, dance_num_macro_reset),
