...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_SNTH] = LAYOUT_split_3x5_3(
        ...
        // LALT_T(KC_X),    LSFT_T(KC_P),    LGUI_T(KC_D),    LCTL_T(KC_M),    KC_Q,                                      KC_MINUS, LCTL_T(KC_Y),     LGUI_T(KC_O),    LSFT_T(KC_U),   LALT_T(KC_QUOT),
        // LALT_T(KC_S),    LSFT_T(KC_N),    LGUI_T(KC_T),    LCTL_T(KC_H),    KC_V,                                      KC_G, LCTL_T(KC_C),     LGUI_T(KC_A),    LSFT_T(KC_E),   LALT_T(KC_I),
        KC_S,    KC_N,    KC_T,    KC_H,    KC_V,                                       KC_G,     KC_C,    KC_A,    KC_E,    KC_I,
        LALT_T(KC_F),    LSFT_T(KC_B),    LGUI_T(KC_K),    LCTL_T(KC_L),    KC_J,                                      KC_Z, LCTL_T(KC_W),     LGUI_T(KC_COMM),    LSFT_T(KC_DOT),   LALT_T(KC_SLSH),
