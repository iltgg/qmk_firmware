...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_SNTH] = LAYOUT_split_3x5_3(
        ...
        KC_F,    KC_B,    KC_K,    KC_L,    KC_J,                               KC_Z,    KC_W,    KC_COMM, KC_DOT,  KC_SLSH,
                       TD(TD_EXT_MOUSE),    KC_R, TD(TD_SYM_FUNC),     KC_BSPC, KC_SPC,  MO(_SHIFT)
    ),
    [_QWERTY] = LAYOUT_split_3x5_3(
        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                               KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                               KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                       TD(TD_EXT_MOUSE),    KC_NO, TD(TD_SYM_FUNC),    KC_BSPC, KC_SPC,  MO(_QWERTY_SHIFT)
    ),
    ...
    [_SYMBOL] = LAYOUT_split_3x5_3(
        ...
        KC_NO,         KC_NO,         KC_BSLS,       KC_PIPE,       KC_AMPR,                              KC_TILD, KC_RPRN, KC_RCBR, KC_RBRC, KC_PLUS,
                                                     KC_NO,         KC_NO,   TD(TD_SYM_FUNC),    KC_SCLN, KC_COLN, MO(_NUMBER)
    ),
    ...
    [_FUNCTION] = LAYOUT_split_3x5_3(
        ...
        KC_NO,         KC_NO,         KC_NO,         KC_NO,         KC_NO,                             KC_F9, KC_F10, KC_F11, KC_F12, TG(_GAMING),
                                                     KC_NO,         KC_NO, TD(TD_SYM_FUNC),     KC_NO, KC_NO, KC_NO
    ),
