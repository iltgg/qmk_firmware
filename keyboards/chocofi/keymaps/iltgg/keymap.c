...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        ...
        KC_F,    KC_B,    KC_K,    KC_L,    KC_J,                               KC_Z,    KC_W,    KC_COMM, KC_DOT,  KC_SLSH,
                                   TD(TD_EXT_MOUSE),   KC_R, MO(4),               KC_BSPC, KC_SPC,  MO(2)
    ),
    // QWERTY Layer
    [1] = LAYOUT_split_3x5_3(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                                   TD(TD_EXT_MOUSE),   KC_NO, MO(4),              KC_BSPC, KC_SPC,  KC_LSFT
    ),
    // Shift Layer
    ...
    [4] = LAYOUT_split_3x5_3(
        ...
        KC_NO,         KC_NO,         KC_BSLS,       KC_PIPE,       KC_AMPR,                      KC_TILD, KC_RPRN, KC_RCBR, KC_RBRC, KC_PLUS,
                                                     KC_NO,         KC_NO,   KC_NO,      KC_SCLN, KC_COLN, MO(5)
    ),
    // Number Layer
    ...
    [7] = LAYOUT_split_3x5_3(
        ...
        KC_NO,         KC_NO,         KC_NO,         KC_NO,         KC_NO,                   KC_F9, KC_F10, KC_F11, KC_F12, TG(9),
                                                     KC_NO,         KC_NO, KC_NO,     KC_NO, KC_NO, KC_NO
    ),
    // Mouse Layer
    ...
    [9] = LAYOUT_split_3x5_3(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,                                KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                                   MO(10),  KC_LALT, KC_SPC,              TG(9), KC_NO,  KC_NO
    ),
    // Gaming Layer Extend
