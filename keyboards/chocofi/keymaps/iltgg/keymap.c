...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_split_3x5_3(
        ...
        OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT),                               KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT,    KC_DEL,
    ...
    [4] = LAYOUT_split_3x5_3(
        ...
        OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), KC_CIRC,   KC_ASTR,KC_LPRN,KC_LCBR,KC_LBRC,KC_UNDS,
        KC_NO,KC_NO,KC_BSLS,KC_PIPE,KC_AMPR,                                   KC_TILD,KC_RPRN,KC_RCBR,KC_RBRC,KC_PLUS,
        KC_NO,KC_NO,KC_NO, KC_NO,KC_NO,MO(4)
    ),
    // Number Layer
    [5] = LAYOUT_split_3x5_3(
        KC_NO,MO(6),KC_COMM,KC_DOT,KC_NUM, KC_EQL,KC_7,KC_8,KC_9,KC_MINUS,
        OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT), KC_ASTR,KC_4,KC_5,KC_6,KC_PLUS,
    ...
    [6] = LAYOUT_split_3x5_3(
        ...
        OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT), KC_PAST,KC_P4,KC_P5,KC_P6,KC_PPLS,
    ...
    [7] = LAYOUT_split_3x5_3(
        ...
        OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), KC_NO,    KC_F5,KC_F6,KC_F7,KC_F8, TG(1),
